...
import {Name, PrivateKey, Serializer, Signature, UInt64} from '@greymass/picoio'
...
describe('signing request', function () {
        ...
        const request = await SigningRequest.create(
            {
                action: {
                    ...
                    data: {from: 'foo', to: 'bar', quantity: '1.000 PICO', memo: 'hello there'},
                },
            },
            options
        )
        ...
        const request = await SigningRequest.create(
            {
                ...
                actions: [
                    ...
                    },
                    {
                        ...
                        data: {from: 'baz', to: 'bar', quantity: '1.000 PICO', memo: 'hello there'},
                    },
                ],
            },
            options
            ...
            actions: [
                {
                    ...
                    data: {from: 'foo', to: 'mractive', quantity: '1.000 PICO', memo: 'hello there'},
                },
            ],
            context_free_actions: [],
            transaction_extensions: [],
        ...
        const request = await SigningRequest.create(
            {
                action: {
                    ...
                    name: 'transfer',
                    authorization: [{actor: 'foo', permission: 'active'}],
                    data: {from: 'foo', to: 'bar', quantity: '1.000 PICO', memo: ''},
                },
            },
            options
        )
    ...
    it('should handle multi-chain id requests', async function () {
        ...
        const req = SigningRequest.identity({
            chainId: null,
            chainIds: [ChainName.PICO, ChainName.WAX],
            scope: 'foo',
            callback: {
                url: 'myapp://login={{cid}}',
                background: false,
        ...
        assert.equal(
            String(proof),
            'PICOIO EGRIezzRqJfOA65baoZWUXR+LhUgkPmcHRnUTgGupaQAAAAAAAAoXXQpCF8AAAAAAAAoXQAAAACo7TIyAB9I36p6NdMCKzksNwp4nFbiEhq8/sVAeji/4JMzk/CHAwc5ipaF8G/SNuXkJ9XWaDSu98DWzbXuvaVcimXUvGDQ'
        )
