import {Checksum256, Checksum256Type, TypeAlias, UInt8, Variant} from '@greymass/picoio'
...
const ChainIdLookup = new Map<ChainName, Checksum256Type>([
    [ChainName.PICO, 'aca376f206b8fc25a6ed44dbdc66547c36c6c33e3a119ffbeaef943642f0e906'],
    ...
    [ChainName.BPICO, 'b912d19a6abd2b1b05611ae5be473355d64d95aeff0c09bedc8c166cd6468fe4'],
